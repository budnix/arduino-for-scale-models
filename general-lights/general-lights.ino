...
const unsigned int REAR_LEFT_INDICATOR_PIN = 3;
const unsigned int REAR_RIGHT_INDICATOR_PIN = 9;
...
void setup() {
  ...
  pinMode(REAR_LEFT_INDICATOR_PIN, OUTPUT);
  pinMode(REAR_RIGHT_INDICATOR_PIN, OUTPUT);
...
void enableLeftIndicator() {
  ...
  setLedState(REAR_LEFT_INDICATOR_PIN, indicatorsToggleTrigger ? 1 : 0);
}
...
void disableLeftIndicator() {
  ...
  setLedState(REAR_LEFT_INDICATOR_PIN, 0);
}
...
void enableRightIndicator() {
  ...
  setLedState(REAR_RIGHT_INDICATOR_PIN, indicatorsToggleTrigger ? 1 : 0);
}
...
void disableRightIndicator() {
  ...
  setLedState(REAR_RIGHT_INDICATOR_PIN, 0);
}
